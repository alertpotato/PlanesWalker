...
namespace Planeswalker.GameObjects.UnitCard
{
    public class UnitCardMain : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _cardText.transform.SetParent(this.transform);
        ...
        public void SetUnitParameters(string unitname, ArmyUnitClass unit, Vector3 _pos)
        {
        ...
        public void OnMouseEnterCollider()
        {
            ...
            transform.position = new Vector3(_startCardPos.x, _startCardPos.y, _startCardPos.z + _approach);
            _cardCollider.GetComponent<BoxCollider>().size = new Vector3(_spriteRenderer.size.x, _spriteRenderer.size.y, 0.1f);
        }
        ...
        {
            Debug.Log("UP");
            EventManager.StartCardChosen(this.gameObject);
        }
